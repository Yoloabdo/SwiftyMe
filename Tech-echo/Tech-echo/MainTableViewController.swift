...
class MainTableViewController: UITableViewController, MWFeedParserDelegate {
    
    var feedItems = [MWFeedItem]()
    func request(){
        let url = NSURL(string: "http://tech-echo.com/feed/")
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.articleDescription.text = item.summary
